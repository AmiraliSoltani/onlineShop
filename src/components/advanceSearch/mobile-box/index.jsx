...
const MobileBox = () => {
  ...
  const settings2 = {
    ...
    beforeChange: (current, next) => {
      ...
      if (next >= scrollLimit) {
        return false; // Stop scrolling if trying to go beyond the limit
      }
    },
  };
...
//     variableWidth: true,
//     beforeChange: (current, next) => {
//         // Prevent scrolling if the next index is out of bounds
//         if (2 >1) {
//           return false; // Stop scrolling if trying to go beyond the last slide
//         }},
//     onSwipe: () => handleSlideScroll(),  // Detect user swipe
//     afterChange: (index) => handleSlideChange(index), // Detect slide index
//   };
